using TDS_VDS_ADD_ON.Resources;
...
namespace TDS_VDS_ADD_ON
{
    class Menu
    {
        public void BasicStart()
        {
            ...
            //CreateMainMenu("FIL_MN_QC", "FIL_CHARMGRP", "Characteristic Master Group", 1, 1, false);
        ...
        public void SBO_Application_MenuEvent(ref SAPbouiCOM.MenuEvent pVal, out bool BubbleEvent)
        {
            ...
            try
            {
                ...
                {
                    Form_TDS_VDS activeForm = new Form_TDS_VDS();
                    activeForm.Show();
                    SAPbouiCOM.Form oform = (SAPbouiCOM.Form)Application.SBO_Application.Forms.Item("FIL_FRM_MH_TDSVDS");
                   // oform.Freeze(true);

                    SAPbouiCOM.DBDataSource DBDataSourceLine = (SAPbouiCOM.DBDataSource)oform.DataSources.DBDataSources.Item("@FIL_MH_TDSVDSM");
